...
public class ParsePartsTest {
    ...
    public void testParseParts1() {
        ...
        String s = "<xml>"
                ...
                + "<part>"
                +   "<chapter>"
                +     "<p>Part 1 Chapter 1 Paragraph 1</p>"
                +   "</chapter>"
                +   "<chapter>"
                +     "<p>Part 1 Chapter 2 Paragraph 1</p>"
                +   "</chapter>"
                + "</part>"
                + "<part>"
                +   "<chapter>"
                +     "<p>Part 2 Chapter 1 Paragraph 1</p>"
                +   "</chapter>"
                +   "<chapter>"
                +     "<p>Part 2 Chapter 2 Paragraph 1</p>"
                +   "</chapter>"
                + "</part>"
                + "</book>";
        String expected = "["
                + "Part:{"
                    ...
                    + "Chapters:{"
                        + "[Chapter:{Numbering:{Chapter I} Id:{ch01001} Normal:{true} Content: 36}, "
                        + "Chapter:{Numbering:{Chapter II} Id:{ch01002} Normal:{true} Content: 36}]"
                    + "}"
                + "}, "
                + "Part:{"
                    + "Info:{Info{TocTitle[null], Title[null], SubTitle[null], Author[null], Date[null], HasCover[false]}}, "
                    ...
                    + "Chapters:{"
                        + "[Chapter:{Numbering:{Chapter I} Id:{ch02001} Normal:{true} Content: 36}, "
                        + "Chapter:{Numbering:{Chapter II} Id:{ch02002} Normal:{true} Content: 36}]"
                    + "}"
                + "}"
            + "]";
    ...
    public void testAllBits() {
        ...
        String s = "<xml>"
                ...
                +     "<subtitle>Subtitle Two</subtitle>"
                +   "</info>"
                +   "<chapter>"
                +     "<info>"
                +       "<title>Chapter Title 1</title>"
        ...
        String expected = "["
                ...
                + "}, "
                + "Part:{"
                    + "Info:{Info{TocTitle[Part Two], Title[Part Two], SubTitle[Subtitle Two], Author[null], Date[null], HasCover[false]}}, "
                    + "Numbering:{Part Two}, Id:{pt02}, "
                    + "Chapters:{"
                        + "[Chapter:{Numbering:{Chapter I} Title:{Chapter Title 1} Id:{ch02001} Normal:{true} Content: 81}, "
                        + "Chapter:{Numbering:{Chapter II} Title:{Chapter Title 2} Id:{ch02002} Normal:{true} Content: 42}]"
                    + "}"
                + "}"
            + "]";
